...
// FINAL BASELINE FK ON DELETE
      ...
      this.addForeignKey({ schema: 'public', table: 'permission', foreignKey: { name: 'permission_permissionGroupId_fkey', columns: ['permissionGroupId'], references: { schema: 'public', table: 'permissionGroup', columns: ['id'] }, onDelete: 'setNull' } }),
